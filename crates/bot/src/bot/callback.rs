...
impl Button {
    pub fn unique(self) -> &'static str {
        match self {
            ...
            Self::SetToggleSourceTitle => "set_toggle_source_title_btn",
    ...
    pub fn from_unique(unique: &str) -> Option<Self> {
        Some(match unique {
            ...
            "set_toggle_source_title_btn" => Self::SetToggleSourceTitle,
...
mod tests {
    ...
    fn all_button_unique_values_match_overview() {
        let buttons = [
            ...
            (Button::SetToggleSourceTitle, "set_toggle_source_title_btn"),
